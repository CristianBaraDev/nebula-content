...
const longString = "The Flying Car From The Future";
...
const lastFiveLetters = "The fast jumping monkey ate my peanuts";
let newString = lastFiveLetters.slice(lastFiveLetters[lastFiveLetters.length]);
